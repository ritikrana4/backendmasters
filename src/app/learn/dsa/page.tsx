...
export const metadata: Metadata = {
  ...
  description:
    "Master DSA fundamentals for technical interviews: arrays, linked lists, trees, recursion, binary search, and dynamic programming — built from first principles with visual diagrams.",
  keywords: ["data structures", "algorithms", "recursion", "binary search", "dynamic programming", "dsa", "leetcode", "technical interview"],
};
    ...
    <div style={{ maxWidth: 720 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
        {course.topics.map((topic, idx) => (
          <Link key={topic.slug} href={`/learn/dsa/${topic.slug}`} style={{ textDecoration: "none" }}>
            <div
              style={{
                display: "flex",
                alignItems: "center",
