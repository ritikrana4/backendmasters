...
export const metadata: Metadata = {
  ...
  description:
    "Learn how the web works: HTTP, REST, authentication, WebSockets, GraphQL, and gRPC. Language-agnostic fundamentals every developer needs.",
  keywords: ["http tutorial", "rest api", "web protocols", "graphql", "websockets", "grpc"],
};

export default function HttpIndexPage() {
  const course = getCourse("http")!;
    ...
    <div style={{ maxWidth: 720 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
        {course.topics.map((topic, idx) => (
          <Link key={topic.slug} href={`/learn/http/${topic.slug}`} style={{ textDecoration: "none" }}>
            <div
              style={{
                display: "flex",
                alignItems: "center",
