...
export const metadata: Metadata = {
  ...
  description:
    "Learn AI engineering from first principles: LLMs, embeddings, RAG, vector databases, AI agents, and how to ship production-grade AI features into real backend systems.",
  keywords: ["AI engineering", "LLM", "RAG", "embeddings", "vector database", "AI agents", "prompt engineering"],
};

export default function AiIndexPage() {
  const course = getCourse("ai")!;
    ...
    <div style={{ maxWidth: 720 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
        {course.topics.map((topic, idx) => (
          <Link key={topic.slug} href={`/learn/ai/${topic.slug}`} style={{ textDecoration: "none" }}>
            <div
              style={{
                display: "flex",
                alignItems: "center",
