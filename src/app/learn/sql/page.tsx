...
export const metadata: Metadata = {
  ...
  keywords: ["sql tutorial", "postgresql", "database design", "sql joins", "transactions acid"],
};
    ...
    <div style={{ maxWidth: 720 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
        {course.topics.map((topic, idx) => (
          <Link key={topic.slug} href={`/learn/sql/${topic.slug}`} style={{ textDecoration: "none" }}>
            <div
              style={{
                display: "flex",
                alignItems: "center",
            ...
            >
              <div
                style={{
                  width: 36,
                  height: 36,
                  background: "rgba(247,158,26,0.1)",
                  border: "1px solid rgba(247,158,26,0.25)",
                  borderRadius: 8,
                  display: "flex",
                  alignItems: "center",
