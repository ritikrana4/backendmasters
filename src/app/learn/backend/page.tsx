...
export const metadata: Metadata = {
  ...
  description:
    "Master production backend engineering: APIs, auth, caching, queues, observability, Docker, CI/CD, and security — from first principles to interview-ready.",
  keywords: ["backend engineering", "api design", "system design", "docker", "cicd", "backend interview"],
};

export default function BackendIndexPage() {
  const course = getCourse("backend")!;
    ...
    <div style={{ maxWidth: 720 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
        {course.topics.map((topic, idx) => (
          <Link key={topic.slug} href={`/learn/backend/${topic.slug}`} style={{ textDecoration: "none" }}>
            <div
              style={{
                display: "flex",
                alignItems: "center",
